...
const ActivCircleStyle =
  "flex w-5 h-5 rounded-full justify-center items-center ";
const ThemeSwithcher = () => {
  const [theme, setTheme] = useState("light");

  useEffect(() => {
    // to call the theme saved in localStorage and work it when refresh the component
  ...
  return (
    <div className="flex h-8 w-14 items-center justify-around rounded-full border-2 bg-[#1F2937]">
      <button
        className={`${ActivCircleStyle} ${theme === "light" ? "bg-white" : ""}`}
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M11.593 1.90356L10.7613 2.73527C10.6795 2.81707 10.6795 2.95027 10.7613 3.03208C10.8022 3.07298 10.8557 3.09396 10.9092 3.09396C10.9627 3.09396 11.0162 3.07298 11.0571 3.03208L11.8888 2.20038C11.9706 2.11857 11.9706 1.98537 11.8888 1.90356C11.807 1.82176 11.6748 1.82176 11.593 1.90356Z"
            fill="#1F2937"
          />
          <path
          ...
          />
          <path
            d="M2.99489 1.90356C2.91308 1.82176 2.77988 1.82176 2.69807 1.90356C2.61627 1.98537 2.61627 2.11857 2.69807 2.20038L3.52978 3.03208C3.57068 3.07298 3.62417 3.09396 3.67766 3.09396C3.73115 3.09396 3.78464 3.07298 3.82554 3.03208C3.90735 2.95027 3.90735 2.81707 3.82554 2.73527L2.99489 1.90356Z"
            fill="#1F2937"
          />
        </svg>
      </button>
      <button
        className={`${ActivCircleStyle} ${theme === "dark" ? "bg-white" : ""}`}
